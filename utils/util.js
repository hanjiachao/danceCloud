...
function redirect_to(router, param){
  var tbar_list = ['/pages/index/index', '/pages/study/study','/pages/personal/personal']
...
function nameinfo(msg, callback) {
  wx.hideLoading()
  setTimeout(function () {
    wx.showToast({
      title: msg,
...
var $app = "https://bbtschool.cn/index.php/Home/";
// var $app = "https://wuyun.hanyu.chuangyiweilai.com/index.php/Home/";
